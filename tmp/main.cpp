...
class StatusMove: public Move{
    ...
    StatusMove(): Move(){}
    StatusMove(string n, string t, unsigned s, unsigned acc, bool phys, unsigned scv, unsigned c): Move(n,t,s,acc,phys), statusCondValue(scv), chance(c){}
...
class Pokemon{
    ...
    bool canAttack(unsigned condValue){
    ...
    void statusStatChange(unsigned condValue){
        switch(condValue){
            case 1:
                currentStats[5] *= 0.25;
                break;
